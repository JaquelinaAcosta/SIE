...
include_once $this->targetDirs[3].'/src/AppBundle/Event/Listener/ModeloListener.php';
...
$c->addEventSubscriber(${($_ = isset($this->services['simplethings_entityaudit.log_revisions_listener']) ? $this->services['simplethings_entityaudit.log_revisions_listener'] : $this->load('getSimplethingsEntityaudit_LogRevisionsListenerService.php')) && false ?: '_'});
$c->addEventSubscriber(${($_ = isset($this->services['simplethings_entityaudit.create_schema_listener']) ? $this->services['simplethings_entityaudit.create_schema_listener'] : $this->load('getSimplethingsEntityaudit_CreateSchemaListenerService.php')) && false ?: '_'});
$c->addEventListener([0 => 'onFlush'], new \AppBundle\Event\Listener\ModeloListener($this));
$c->addEventListener([0 => 'loadClassMetadata'], ${($_ = isset($this->services['doctrine.orm.default_listeners.attach_entity_listeners']) ? $this->services['doctrine.orm.default_listeners.attach_entity_listeners'] : ($this->services['doctrine.orm.default_listeners.attach_entity_listeners'] = new \Doctrine\ORM\Tools\AttachEntityListenersListener())) && false ?: '_'});

return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'SIE', 'user' => 'admin', 'password' => 'admin', 'charset' => 'UTF8', 'driverOptions' => [], 'defaultTableOptions' => []], $a, $c, []);
