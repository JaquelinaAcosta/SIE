...
class Usuario extends \AppBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'iup', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'contrasenia', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'saved_password', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'role', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'persona', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'responsables', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'resolucion', 'fechaBaja', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'fechaAlta', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'fechaUltimaModificacion', '' . "\0" . 'AppBundle\\Entity\\Usuario' . "\0" . 'usuarioUltimaModificacion'];
        }
    ...
    public function getValidarPassword()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getValidarPassword', []);

        return parent::getValidarPassword();
    }
