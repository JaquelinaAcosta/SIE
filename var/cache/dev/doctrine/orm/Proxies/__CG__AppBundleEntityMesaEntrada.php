 ...
 */
class MesaEntrada extends \AppBundle\Entity\MesaEntrada implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\MesaEntrada' . "\0" . 'codigoExpediente', '' . "\0" . 'AppBundle\\Entity\\MesaEntrada' . "\0" . 'telefono', 'id', 'fechaBaja'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MesaEntrada $proxy) {
