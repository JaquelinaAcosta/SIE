...
class __TwigTemplate_dbd1e36e108055d41a4b993b492641f5aea9a6aa23ef362324a0bad85e0098a8 extends \Twig\Template
{
    ...
    <div class=\"col-ls-12 col-md-offset-1\">
        <div class=\"panel panel-primary \">
            <div class=\"title panel-heading\">Expediente -> Movimiento</div>
            <div class=\"panel panel-body\">
               <h3 class=\"text-default\">Expediente Número: ";
        // line 22
        ...
        echo "
                 ...
                 <div class=\"col-lg-2\">
                        <label class=\"text-default\">FECHA</label>
                        ";
        // line 31
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "fecha", []), 'row', ["id" => "date1"]);
        echo " 
                        ";
        // line 32
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "fecha", []), 'errors');
        echo "
                        ";
        // line 33
...
";
    ...
    {
        return array (  109 => 36,  103 => 33,  99 => 32,  95 => 31,  88 => 27,  80 => 22,  60 => 4,  51 => 3,  29 => 1,);
    }
...
{% block content %}
    ...
    <div class=\"col-ls-12 col-md-offset-1\">
        <div class=\"panel panel-primary \">
            <div class=\"title panel-heading\">Expediente -> Movimiento</div>
            <div class=\"panel panel-body\">
               <h3 class=\"text-default\">Expediente Número: {{ expediente.nroExpediente }}</h3>
