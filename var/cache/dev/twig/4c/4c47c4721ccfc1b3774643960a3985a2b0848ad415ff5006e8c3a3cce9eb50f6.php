...
class __TwigTemplate_ed07f0fac41d562c416af6877cc09465a6566e78424b79c17a31aeecc4ab1d1c extends \Twig\Template
{
    ...
    <div class=\"panel\">
        ...
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("ver_expediente", ["id" => $this->getAttribute(($context["expediente"] ?? $this->getContext($context, "expediente")), "id", [])]), "html", null, true);
        echo "\"  
...
{% block content %}
    ...
    <div class=\"panel\">
        ...
        <a class=\"btn btn-default\" href=\"{{ path(\"ver_expediente\", {'id':expediente.id}) }}\"  
           role=\"button\" data-toggle=\"tooltip\" data-placement=\"top\" 
           title=\"Movimiento Externo\">EXTERNO<i class=\"fas fa-search\"></i></a>
