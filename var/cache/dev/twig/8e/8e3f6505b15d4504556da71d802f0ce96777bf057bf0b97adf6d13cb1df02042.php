...
class __TwigTemplate_c6f7b895287bf33596b5896998f73c4cb98c851bec4b959131fd34799dec7b13 extends \Twig\Template
{
    ...
    <div class=\"content\">
        ...
        if ((twig_length_filter($this->env, ($context["dependencias"] ?? $this->getContext($context, "dependencias"))) > 0)) {
            ...
            // line 108
            echo twig_escape_filter($this->env, twig_length_filter($this->env, ($context["dependencias"] ?? $this->getContext($context, "dependencias"))), "html", null, true);
            echo " &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            </div>
            <hr/>
        ";
...
{% block contentmain %}
    ...
    <div class=\"content\">
        ...
        {% if dependencias|length >0 %}
            <hr/>
            <div class=\"alert alert-info\">
                <i class=\"fas fa-search\"></i> Resultados de la búsqueda: {{ dependencias|length }} &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            </div>
            <hr/>
        {% else %}
            <div class=\"alert alert-info\">
