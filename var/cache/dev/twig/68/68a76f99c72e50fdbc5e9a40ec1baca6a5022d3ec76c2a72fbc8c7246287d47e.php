...
";
    ...
    {
        return array (  154 => 74,  145 => 71,  140 => 70,  135 => 66,  131 => 65,  127 => 64,  124 => 63,  120 => 62,  60 => 4,  51 => 3,  29 => 1,);
    }
...
{#                        <td><a class=\"btn btn-info\" href=\"{{ path(\"editar_usuario\", {'id':usuario.id}) }}\"  role=\"button\"><i class=\"fas fa-search\"></i></a>#}
                       <td> <a class=\"btn btn-warning\" href=\"{{ path(\"editar_usuario\", {'id':usuario.id}) }}\"  role=\"button\"><i class=\"fas fa-edit\"></i></a>
                        <a class=\"btn btn-danger\" href=\"{{ path(\"eliminar_usuario\", {'id':usuario.id}) }}\"  role=\"button\"><i class=\"fas fa-trash-alt\"></i></a></td>
                </tr>
            {% endfor %}
