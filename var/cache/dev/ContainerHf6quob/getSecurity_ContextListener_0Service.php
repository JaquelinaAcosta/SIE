...
$this->services['security.context_listener.0'] = $instance = new \Symfony\Component\Security\Http\Firewall\ContextListener(${($_ = isset($this->services['security.token_storage']) ? $this->services['security.token_storage'] : ($this->services['security.token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())) && false ?: '_'}, new RewindableGenerator(function () {
    ...
    yield 1 => ${($_ = isset($this->services['security.user.provider.concrete.db_username']) ? $this->services['security.user.provider.concrete.db_username'] : $this->load('getSecurity_User_Provider_Concrete_DbUsernameService.php')) && false ?: '_'};
    yield 2 => ${($_ = isset($this->services['security.user.provider.concrete.db_email']) ? $this->services['security.user.provider.concrete.db_email'] : $this->load('getSecurity_User_Provider_Concrete_DbEmailService.php')) && false ?: '_'};
