...
class ExpedienteAsociadoRepository extends \Doctrine\ORM\EntityRepository {
    ...
    public function createAsociadoFilterQuery($expediente) {
        ...
        $result = $qb->select('ea')
                ...
                ->innerJoin(\AppBundle\Entity\Expediente::class, "e", "WITH", "ea.expedienteAsociado=e.id")
                ->innerJoin(\AppBundle\Entity\Tema::class, "t", "WITH", "e.tema=t.id")
